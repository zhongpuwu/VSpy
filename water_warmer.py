...
for i in range(0, 900):
    ...
    if(l1[0] >= 60):
        flag = 0
    if(flag == 0):
        Q = 0-Radiation(l1[0], T2)*1.0+(T2-l1[0])*OutV(l1[0], T2, 42)/0.06  # 不加热时能量的变化
    if(flag == 1):
        Q = 0-Radiation(l1[0], T2)*1.0+(T2-l1[0])*OutV(l1[0], T2, 42)/0.06+1500*1.0  # 加热时能量的变化
